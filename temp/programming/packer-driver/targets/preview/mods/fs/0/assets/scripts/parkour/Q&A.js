    ...
    execute: function () {
      ...
      _export("QA", QA = (_dec = ccclass('QA'), _dec2 = property({
        ...
        function QA() {
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "gameManager", _descriptor, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "playerControl", _descriptor2, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "isTrue", _descriptor3, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "questions", _descriptor4, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "question", _descriptor5, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "downCount", _descriptor6, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "globalFunc", _descriptor7, _assertThisInitialized(_this));
        ...
        _proto.Select = function Select(event) {
          ...
          console.log(this);
          var lab = btn.children[2].getComponent(Label);
        ...
        _proto.ResetStatus = function ResetStatus() {
          for (var i = 0; i < this.questions.children.length; i++) {
            ...
            var lab = this.questions.children[i].children[2].getComponent(Label);
        ...
        return QA;
      }(Component), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "gameManager", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
