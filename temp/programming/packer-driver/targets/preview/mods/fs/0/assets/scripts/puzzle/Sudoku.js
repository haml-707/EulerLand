    ...
    execute: function () {
      ...
      _export("Sudoku", Sudoku = (_dec = ccclass('Sudoku'), _dec2 = property({
        ...
        function Sudoku() {
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "sudoku", _descriptor, _assertThisInitialized(_this));
        ...
        _proto.OpenSu = function OpenSu() {
          this.sudoku.active = true;
        };

        _proto.NumberAdd = function NumberAdd(event) {
          var btn = event.target;
          var label = btn.children[9].getComponent(Label);
        ...
        return Sudoku;
      }(Component), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "sudoku", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
