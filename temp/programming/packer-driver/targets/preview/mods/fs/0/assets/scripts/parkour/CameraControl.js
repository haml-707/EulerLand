System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, Node, _dec, _dec2, _class, _class2, _descriptor, _temp, _crd, ccclass, property, Typescript;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "a991bFW+tlML7xu2kAVy9NM", "CameraControl", undefined);

      ccclass = _decorator.ccclass;
      property = _decorator.property;

      _export("Typescript", Typescript = (_dec = ccclass('Typescript'), _dec2 = property({
        type: Node
