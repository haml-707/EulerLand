  ...
  return {
    ...
    execute: function () {
      ...
      _export("Typescript001", Typescript001 = (_dec = ccclass('Typescript001'), _dec2 = property({
        ...
        _inheritsLoose(Typescript001, _Component);

        function Typescript001() {
          var _this;
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "n1", _descriptor, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "n2", _descriptor2, _assertThisInitialized(_this));

          _defineProperty(_assertThisInitialized(_this), "aaa", 0);

          _defineProperty(_assertThisInitialized(_this), "sss", false);

          return _this;
        }

        var _proto = Typescript001.prototype;

        _proto.A = function A() {
          var framesize = view.getFrameSize();
          var node = find("Canvas");
          var cvsize = view.getCanvasSize(); // let dw = cvs
          ...
          var a = view.getDesignResolutionSize();
          var b = view.getCanvasSize();
          console.log(a);
          console.log(b);
        ...
        _proto.onLoad = function onLoad() {// this.A();
        ...
        return Typescript001;
      }(Component), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "n1", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
